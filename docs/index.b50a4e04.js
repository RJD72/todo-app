 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tq=new ev("@firebase/firestore");function t$(){return tq.logLevel}function tz(e,...t){if(tq.logLevel<=a.DEBUG){let r=t.map(tH);tq.debug(`Firestore (${tj}): ${e}`,...r)}}function tG(e,...t){if(tq.logLevel<=a.ERROR){let r=t.map(tH);tq.error(`Firestore (${tj}): ${e}`,...r)}}function tK(e,...t){if(tq.logLevel<=a.WARN){let r=t.map(tH);tq.warn(`Firestore (${tj}): ${e}`,...r)}}function tH(e){if("string"==typeof e)return e;try{/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tJ{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class tZ{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(tF.UNAUTHENTICATED))}shutdown(){}}class t0{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable(()=>t(this.token.user))}shutdown(){this.changeListener=null}}class t1{constructor(e){this.t=e,this.currentUser=tF.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){void 0===this.o||tQ();let r=this.i,n=e=>this.i!==r?(r=this.i,t(e)):Promise.resolve(),i=new tY;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new tY,e.enqueueRetryable(()=>n(this.currentUser))};let s=()=>{let t=i;e.enqueueRetryable(async()=>{await t.promise,await n(this.currentUser)})},o=e=>{tz("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=e,this.o&&(this.auth.addAuthTokenListener(this.o),s())};this.t.onInit(e=>o(e)),setTimeout(()=>{if(!this.auth){let e=this.t.getImmediate({optional:!0});e?o(e):(tz("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new tY)}},0),s()}getToken(){let e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(t=>this.i!==e?(tz("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):t?("string"==typeof t.accessToken||tQ(),new tJ(t.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){let e=this.auth&&this.auth.getUid();return null===e||"string"==typeof e||tQ(),new tF(e)}}class t2{constructor(e,t,r){this.l=e,this.h=t,this.P=r,this.type="FirstParty",this.user=tF.FIRST_PARTY,this.T=new Map}I(){return this.P?this.P():null}get headers(){this.T.set("X-Goog-AuthUser",this.l);let e=this.I();return e&&this.T.set("Authorization",e),this.h&&this.T.set("X-Goog-Iam-Authorization-Token",this.h),this.T}}class t6{constructor(e,t,r){this.l=e,this.h=t,this.P=r}getToken(){return Promise.resolve(new t2(this.l,this.h,this.P))}start(e,t){e.enqueueRetryable(()=>t(tF.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class t5{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class t3{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,t){void 0===this.o||tQ();let r=e=>{null!=e.error&&tz("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${e.error.message}`);let r=e.token!==this.R;return this.R=e.token,tz("FirebaseAppCheckTokenProvider",`Received ${r?"new":"existing"} token.`),r?t(e.token):Promise.resolve()};this.o=t=>{e.enqueueRetryable(()=>r(t))};let n=e=>{tz("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=e,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(e=>n(e)),setTimeout(()=>{if(!this.appCheck){let e=this.A.getImmediate({optional:!0});e?n(e):tz("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){let e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(e=>e?("string"==typeof e.token||tQ(),this.R=e.token,new t5(e.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rl(e){if(e.code!==tW.FAILED_PRECONDITION||"The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab."!==e.message)throw e;tz("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iz{constructor(){this.changes=new nw(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,rX.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();let r=this.changes.get(t);return void 0!==r?rh.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sa{constructor(){this.co=()=>this.lo(),this.ho=()=>this.Po(),this.To=[],this.Io()}uo(e){this.To.push(e)}shutdown(){window.removeEventListener("online",this.co),window.removeEventListener("offline",this.ho)}Io(){window.addEventListener("online",this.co),window.addEventListener("offline",this.ho)}lo(){for(let e of(tz("ConnectivityMonitor","Network connectivity changed: AVAILABLE"),this.To))e(0)}Po(){for(let e of(tz("ConnectivityMonitor","Network connectivity changed: UNAVAILABLE"),this.To))e(1)}static p(){return"undefined"!=typeof window&&void 0!==window.addEventListener&&void 0!==window.removeEventListener}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sf="WebChannelConnection";class sd extends class{get Co(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;let t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),n=encodeURIComponent(this.databaseId.database);this.Fo=t+"://"+e.host,this.Mo=`projects/${r}/databases/${n}`,this.xo="(default)"===this.databaseId.database?`project_id=${r}`:`project_id=${r}&database_id=${n}`}Oo(e,t,r,n,i){let s=sh(),o=this.No(e,t.toUriEncodedString());tz("RestConnection",`Sending RPC '${e}' ${s}:`,o,r);let a={"google-cloud-resource-prefix":this.Mo,"x-goog-request-params":this.xo};return this.Bo(a,n,i),this.Lo(e,o,a,r).then(t=>(tz("RestConnection",`Received RPC '${e}' ${s}: `,t),t),t=>{throw tK("RestConnection",`RPC '${e}' ${s} failed with error: `,t,"url: ",o,"request:",r),t})}ko(e,t,r,n,i,s){return this.Oo(e,t,r,n,i)}Bo(e,t,r){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+tj}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((t,r)=>e[r]=t),r&&r.headers.forEach((t,r)=>e[r]=t)}No(e,t){let r=su[e];return`${this.Fo}/v1/${t}:${r}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Lo(e,t,r,n){let i=sh();return new Promise((s,o)=>{let a=new u;a.setWithCredentials(!0),a.listenOnce(f.COMPLETE,()=>{try{switch(a.getLastErrorCode()){case d.NO_ERROR:let t=a.getResponseJson();tz(sf,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(t)),s(t);break;case d.TIMEOUT:tz(sf,`RPC '${e}' ${i} timed out`),o(new tX(tW.DEADLINE_EXCEEDED,"Request time out"));break;case d.HTTP_ERROR:let r=a.getStatus();if(tz(sf,`RPC '${e}' ${i} failed with status:`,r,"response text:",a.getResponseText()),r>0){let e=a.getResponseJson();Array.isArray(e)&&(e=e[0]);let t=null==e?void 0:e.error;if(t&&t.status&&t.message){let e=function(e){let t=e.toLowerCase().replace(/_/g,"-");return Object.values(tW).indexOf(t)>=0?t:tW.UNKNOWN}(t.status);o(new tX(e,t.message))}else o(new tX(tW.UNKNOWN,"Server responded with status "+a.getStatus()))}else o(new tX(tW.UNAVAILABLE,"Connection failed."));break;default:tQ()}}finally{tz(sf,`RPC '${e}' ${i} completed.`)}});let l=JSON.stringify(n);tz(sf,`RPC '${e}' ${i} sending request:`,n),a.send(t,"POST",l,r,15)})}qo(e,t,r){let n=sh(),i=[this.Fo,"/","google.firestore.v1.Firestore","/",e,"/channel"],s=y(),o=m(),a={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},l=this.longPollingOptions.timeoutSeconds;void 0!==l&&(a.longPollingTimeout=Math.round(1e3*l)),this.useFetchStreams&&(a.useFetchStreams=!0),this.Bo(a.initMessageHeaders,t,r),a.encodeInitMessageHeaders=!0;let h=i.join("");tz(sf,`Creating RPC '${e}' stream ${n}: ${h}`,a);let u=s.createWebChannel(h,a),f=!1,d=!1,v=new sc({Eo:t=>{d?tz(sf,`Not sending because RPC '${e}' stream ${n} is closed:`,t):(f||(tz(sf,`Opening RPC '${e}' stream ${n} transport.`),u.open(),f=!0),tz(sf,`RPC '${e}' stream ${n} sending:`,t),u.send(t))},Ao:()=>u.close()}),w=(e,t,r)=>{e.listen(t,e=>{try{r(e)}catch(e){setTimeout(()=>{throw e},0)}})};return w(u,c.EventType.OPEN,()=>{d||(tz(sf,`RPC '${e}' stream ${n} transport opened.`),v.So())}),w(u,c.EventType.CLOSE,()=>{d||(d=!0,tz(sf,`RPC '${e}' stream ${n} transport closed`),v.Do())}),w(u,c.EventType.ERROR,t=>{d||(d=!0,tK(sf,`RPC '${e}' stream ${n} transport errored:`,t),v.Do(new tX(tW.UNAVAILABLE,"The operation could not be completed")))}),w(u,c.EventType.MESSAGE,t=>{var r;if(!d){let i=t.data[0];i||tQ();let s=(null==i?void 0:i.error)||(null===(r=i[0])||void 0===r?void 0:r.error);if(s){tz(sf,`RPC '${e}' stream ${n} received error:`,s);let t=s.status,r=function(e){let t=_[e];if(void 0!==t)return n3(t)}(t),i=s.message;void 0===r&&(r=tW.INTERNAL,i="Unknown error status: "+t+" with message "+s.message),d=!0,v.Do(new tX(r,i)),u.close()}else tz(sf,`RPC '${e}' stream ${n} received:`,i),v.vo(i)}}),w(o,g.STAT_EVENT,t=>{t.stat===p.PROXY?tz(sf,`RPC '${e}' stream ${n} detected buffering proxy`):t.stat===p.NOPROXY&&tz(sf,`RPC '${e}' stream ${n} detected no buffering proxy`)}),setTimeout(()=>{v.bo()},0),v}}function sp(){return"undefined"!=typeof document?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.C_?(tG(t),this.C_=!1):tz("OnlineStateTracker",t)}N_(){null!==this.v_&&(this.v_.cancel(),this.v_=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oJ{constructor(e){this._byteString=e}static fromBase64String(e){try{return new oJ(rT.fromBase64String(e))}catch(e){throw new tX(tW.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}static fromUint8Array(e){return new oJ(rT.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oZ{constructor(...e){for(let t=0;t<e.length;++t)if(0===e[t].length)throw new tX(tW.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new ri(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class o1{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new tX(tW.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new tX(tW.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return t4(this._lat,e._lat)||t4(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class o2{constructor(e){this._values=(e||[]).map(e=>e)}toArray(){return this._values.map(e=>e)}isEqual(e){return function(e,t){if(e.length!==t.length)return!1;for(let r=0;r<e.length;++r)if(e[r]!==t[r])return!1;return!0}(this._values,e._values)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const o6=/^__.*__$/;class o5{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return new nW(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function o3(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw tQ()}}class o8{constructor(e,t,r,n,i,s){this.settings=e,this.databaseId=t,this.serializer=r,this.ignoreUndefinedProperties=n,void 0===i&&this.Fu(),this.fieldTransforms=i||[],this.fieldMask=s||[]}get path(){return this.settings.path}get Mu(){return this.settings.Mu}xu(e){return new o8(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Ou(e){var t;let r=null===(t=this.path)||void 0===t?void 0:t.child(e),n=this.xu({path:r,Nu:!1});return n.Bu(e),n}Lu(e){var t;let r=null===(t=this.path)||void 0===t?void 0:t.child(e),n=this.xu({path:r,Nu:!1});return n.Fu(),n}ku(e){return this.xu({path:void 0,Nu:!0})}qu(e){return as(e,this.settings.methodName,this.settings.Qu||!1,this.path,this.settings.Ku)}contains(e){return void 0!==this.fieldMask.find(t=>e.isPrefixOf(t))||void 0!==this.fieldTransforms.find(t=>e.isPrefixOf(t.field))}Fu(){if(this.path)for(let e=0;e<this.path.length;e++)this.Bu(this.path.get(e))}Bu(e){if(0===e.length)throw this.qu("Document fields must not be empty");if(o3(this.Mu)&&o6.test(e))throw this.qu('Document fields cannot begin and end with "__"')}}class o4{constructor(e,t,r){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=r||sg(e)}$u(e,t,r,n=!1){return new o8({Mu:e,methodName:t,Ku:r,path:ri.emptyPath(),Nu:!1,Qu:n},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}class o7 extends o0{_toFieldTransform(e){if(2!==e.Mu)throw 1===e.Mu?e.qu(`${this._methodName}() can only appear at the top level of your update data`):e.qu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof o7}}function o9(e,t){if(ae(e=el(e)))return at("Unsupported field value:",t,e),function(e,t){let r={};return rg(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):rp(e,(e,n)=>{let i=o9(n,t.Ou(e));null!=i&&(r[e]=i)}),{mapValue:{fields:r}}}(e,t);if(e instanceof o0)return function(e,t){if(!o3(t.Mu))throw t.qu(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t.qu(`${e._methodName}() is not currently supported inside arrays`);let r=e._toFieldTransform(t);r&&t.fieldTransforms.push(r)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.Nu&&4!==t.Mu)throw t.qu("Nested arrays are not supported");return function(e,t){let r=[],n=0;for(let i of e){let e=o9(i,t.ku(n));null==e&&(e={nullValue:"NULL_VALUE"}),r.push(e),n++}return{arrayValue:{values:r}}}(e,t)}return function(e,t){var r,n,i;if(null===(e=el(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return r=t.serializer,"number"==typeof(i=n=e)&&Number.isInteger(i)&&!rf(i)&&i<=Number.MAX_SAFE_INTEGER&&i>=Number.MIN_SAFE_INTEGER?nk(n):nD(r,n);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){let r=t9.fromDate(e);return{timestampValue:iy(t.serializer,r)}}if(e instanceof t9){let r=new t9(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:iy(t.serializer,r)}}if(e instanceof o1)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof oJ)return{bytesValue:iv(t.serializer,e._byteString)};if(e instanceof oH){let r=t.databaseId,n=e.firestore._databaseId;if(!n.isEqual(r))throw t.qu(`Document reference is for database ${n.projectId}/${n.database} but should be for database ${r.projectId}/${r.database}`);return{referenceValue:ib(e.firestore._databaseId||t.databaseId,e._key.path)}}if(e instanceof o2)return{mapValue:{fields:{__type__:{stringValue:"__vector__"},value:{arrayValue:{values:e.toArray().map(e=>{if("number"!=typeof e)throw t.qu("VectorValues must only contain numeric values.");return nD(t.serializer,e)})}}}}};throw t.qu(`Unsupported field value: ${oq(e)}`)}(e,t)}function ae(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof t9||e instanceof o1||e instanceof oJ||e instanceof oH||e instanceof o0||e instanceof o2)}function at(e,t,r){if(!ae(r)||!("object"==typeof r&&null!==r&&(Object.getPrototypeOf(r)===Object.prototype||null===Object.getPrototypeOf(r)))){let n=oq(r);throw"an object"===n?t.qu(e+" a custom object"):t.qu(e+" "+n)}}function ar(e,t,r){if((t=el(t))instanceof oZ)return t._internalPath;if("string"==typeof t)return ai(e,t);throw as("Field path arguments must be of type string or ",e,!1,void 0,r)}const an=RegExp("[~\\*/\\[\\]]");function ai(e,t,r){if(t.search(an)>=0)throw as(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,r);try{return new oZ(...t.split("."))._internalPath}catch(n){throw as(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,r)}}function as(e,t,r,n,i){let s=n&&!n.isEmpty(),o=void 0!==i,a=`Function ${t}() called with invalid data`;r&&(a+=" (via `toFirestore()`)"),a+=". ";let l="";return(s||o)&&(l+=" (found",s&&(l+=` in field ${n}`),o&&(l+=` in document ${i}`),l+=")"),new tX(tW.INVALID_ARGUMENT,a+e+l)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class au{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class ac extends ao{constructor(e,t,r,n,i,s){super(e,t,r,n,s),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){let t=new af(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){let r=this._document.data.field(al("DocumentSnapshot.get",e));if(null!==r)return this._userDataWriter.convertValue(r,t.serverTimestamps)}}}class af extends ac{data(e={}){return super.data(e)}}class ad{constructor(e,t,r,n){this._firestore=e,this._userDataWriter=t,this._snapshot=n,this.metadata=new au(n.hasPendingWrites,n.fromCache),this.query=r}get docs(){let e=[];return this.forEach(t=>e.push(t)),e}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(e,t){this._snapshot.docs.forEach(r=>{e.call(t,new af(this._firestore,this._userDataWriter,r.key,r,new au(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){let t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new tX(tW.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(e,t){if(e._snapshot.oldDocs.isEmpty()){let t=0;return e._snapshot.docChanges.map(r=>{let n=new af(e._firestore,e._userDataWriter,r.doc.key,r.doc,new au(e._snapshot.mutatedKeys.has(r.doc.key),e._snapshot.fromCache),e.query.converter);return r.doc,{type:"added",doc:n,oldIndex:-1,newIndex:t++}})}{let r=e._snapshot.oldDocs;return e._snapshot.docChanges.filter(e=>t||3!==e.type).map(t=>{let n=new af(e._firestore,e._userDataWriter,t.doc.key,t.doc,new au(e._snapshot.mutatedKeys.has(t.doc.key),e._snapshot.fromCache),e.query.converter),i=-1,s=-1;return 0!==t.type&&(i=r.indexOf(t.doc.key),r=r.delete(t.doc.key)),1!==t.type&&(s=(r=r.add(t.doc)).indexOf(t.doc.key)),{type:function(e){switch(e){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return tQ()}}(t.type),doc:n,oldIndex:i,newIndex:s}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}class ap extends ah{constructor(e){super(),this.firestore=e}convertBytes(e){return new oJ(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new oH(this.firestore,null,t)}}new WeakMap,function(e=!0){tj="11.2.0",eq(new eh("firestore",(t,{instanceIdentifier:r,options:n})=>{let i=t.getProvider("app").getImmediate(),s=new oX(new t1(t.getProvider("auth-internal")),new t3(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new tX(tW.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new rR(e.options.projectId,t)}(i,r),i);return n=Object.assign({useFetchStreams:e},n),s._setSettings(n),s},"PUBLIC").setMultipleInstances(!0)),eK(tV,"4.7.6",void 0),eK(tV,"4.7.6","esm2017")}();const ag=document.getElementById("taskList"),am=document.getElementById("openModalBtn"),ay=document.getElementById("closeModalBtn"),av=document.getElementById("modal"),aw=document.getElementById("dropdownBtn"),ab=document.getElementById("dropdown");document.getElementById("notification");const aE=function(e,t){let r=(function(e,t){let r=e.container.getProvider("heartbeat").getImmediate({optional:!0});return r&&r.triggerHeartbeat(),e.container.getProvider(t)})("object"==typeof e?e:function(e=eP){let t=eB.get(e);if(!t&&e===eP&&et())return eG();if(!t)throw e$.create("no-app",{appName:e});return t}(),"firestore").getImmediate({identifier:"string"==typeof e?e:"(default)"});if(!r._initialized){let e=ee("firestore");e&&function(e,t,r,n={}){var i;let s=(e=o$(e,oG))._getSettings(),o=`${t}:${r}`;if("firestore.googleapis.com"!==s.host&&s.host!==o&&tK("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used."),e._setSettings(Object.assign(Object.assign({},s),{host:o,ssl:!1})),n.mockUserToken){let t,r;if("string"==typeof n.mockUserToken)t=n.mockUserToken,r=tF.MOCK_USER;else{t=function(e,t){if(e.uid)throw Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');let r=t||"demo-project",n=e.iat||0,i=e.sub||e.user_id;if(!i)throw Error("mockUserToken must contain 'sub' or 'user_id' field!");let s=Object.assign({iss:`https://securetoken.google.com/${r}`,aud:r,iat:n,exp:n+3600,auth_time:n,sub:i,user_id:i,firebase:{sign_in_provider:"custom",identities:{}}},e);return[H(JSON.stringify({alg:"none",type:"JWT"})),H(JSON.stringify(s)),""].join(".")}(n.mockUserToken,null===(i=e._app)||void 0===i?void 0:i.options.projectId);let s=n.mockUserToken.sub||n.mockUserToken.user_id;if(!s)throw new tX(tW.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");r=new tF(s)}e._authCredentials=new t0(new tJ(t,r))}}(r,...e)}return r}(eG({apiKey:"AIzaSyA3n0yJDEGULLwPmO5PlY906sVxjVTYLnw",authDomain:"my-first-pwa-1af14.firebaseapp.com",projectId:"my-first-pwa-1af14",storageBucket:"my-first-pwa-1af14.appspot.com",messagingSenderId:"764859055293",appId:"1:764859055293:web:e912e7c3e2bd74098b4bd4"}));var a_={};if(a_=new URL("service-worker.833c79d9.js",import.meta.url).toString(),"serviceWorker"in navigator){let e=new URL(a_);navigator.serviceWorker.register(e.href,{scope:"/todo-app/"}).then(()=>console.log("Service Worker Registered")).catch(e=>console.error("Service Worker Error:",e))}async function aT(){try{let e=await aS();ag.innerHTML="",e.forEach(e=>{if(!e.data().completed){let t=document.createElement("li");t.id=e.id,t.textContent=e.data().text,t.tabIndex=0,ag.appendChild(t)}})}catch(e){console.error("Error fetching tasks:",e)}}async function aI(e){if(("click"===e.type||"Enter"===e.key)&&"LI"===e.target.tagName){let t=e.target;await function(e,t,r,...n){var i;e=o$(e,oH);let s=o$(e.firestore,oX),o=function(e){let t=e._freezeSettings(),r=sg(e._databaseId);return new o4(e._databaseId,!!t.ignoreUndefinedProperties,r)}(s);return i=[("string"==typeof(t=el(t))||t instanceof oZ?function(e,t,r,n,i,s){let o=e.$u(1,t,r),a=[ar(t,n,r)],l=[i];if(s.length%2!=0)throw new tX(tW.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)a.push(ar(t,s[e])),l.push(s[e+1]);let h=[],u=rW.empty();for(let e=a.length-1;e>=0;--e)if(!function(e,t){return e.some(e=>e.isEqual(t))}(h,a[e])){let t=a[e],r=l[e];r=el(r);let n=o.Lu(t);if(r instanceof o7)h.push(t);else{let e=o9(r,n);null!=e&&(h.push(t),u.set(t,e))}}return new o5(u,new rE(h),o.fieldTransforms)}(o,"updateDoc",e._key,t,void 0,n):function(e,t,r,n){let i=e.$u(1,t,r);at("Data must be an object, but it was:",i,n);let s=[],o=rW.empty();return rp(n,(e,n)=>{let a=ai(t,e,r);n=el(n);let l=i.Lu(a);if(n instanceof o7)s.push(a);else{let e=o9(n,l);null!=e&&(s.push(a),o.set(a,e))}}),new o5(o,new rE(s),i.fieldTransforms)}(o,"updateDoc",e._key,t)).toMutation(e._key,nq.exists(!0))],function(e,t){let r=new tY;return e.asyncQueue.enqueueAndForget(async()=>oc(await oM(e).then(e=>e.syncEngine),t,r)),r.promise}(oY(s),i)}(function(e,t,...r){if(e=el(e),1==arguments.length&&(t=t8.newId()),oV("doc","path",t),e instanceof oG){let n=rr.fromString(t,...r);return oF(n),new oH(e,null,new rs(n))}{if(!(e instanceof oH||e instanceof oQ))throw new tX(tW.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");let n=e._path.child(rr.fromString(t,...r));return oF(n),new oH(e.firestore,e instanceof oQ?e.converter:null,new rs(n))}}(aE,"todos",t.id),{completed:!0}),t.classList.add("completed"),setTimeout(aT,500)}}async function aS(){return(await function(e){e=o$(e,oK);let t=o$(e.firestore,oX),r=oY(t),n=new ap(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
